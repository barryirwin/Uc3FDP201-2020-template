...
%% ----------------------------  START Citation Support ----------------------------
    %% Add your citation system of choice in here - biber or bibtex.
    %% remember author, year citation stile is required *not* numbers as in IEEE
%% ----------------------------  END Citation Support ----------------------------
...
%% This is highly recommended for making your life easier managing each chapter 
%% and any images related to it -- see the ch1 example directory.

%% ---------------------------- END Document Body ----------------------------


%% -------  START References ----------
    %% include the appropriate code to generate your reference list based on your choice of bibtex or biber.
%% -------  END References ----------
